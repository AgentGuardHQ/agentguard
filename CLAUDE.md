...
policies/                   # Policy packs (ci-safe, engineering-standards, enterprise, hipaa, open-source, soc2, strict as subdirs; essentials.yaml and readybench.yaml as flat files)
